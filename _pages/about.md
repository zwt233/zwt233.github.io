...
Research Interests
---
+ **Data-centric ML**: Quantity (e.g., annotation and augmentation), Quality (e.g., imbalance, noise and OOD), Efficiency (e.g., distillation, compression, and selection), and Privacy (e.g., attack and FL).

+ **Graph ML**: GNN Scalability, DCML on Graph.

+ **ML Systems**: Large-scale Distributed Training, AutoML, and DCML platform.
