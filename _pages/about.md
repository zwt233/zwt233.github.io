...
- **Data**: how to utilize massive unlabeled nodes in large-scale graph data? -- Data-centric Graph ML
...
- **Model**: how to build scalable and deep graph models for large-scale graph data? -- Scalable Graph ML
...
- **System**:  how to make large-scale graph learning faster and easier ? -- AutoML on Graph
