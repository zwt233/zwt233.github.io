...
------
* August 2021: Three papers (with one of them as first author) were submitted to the coference ***VLDB 2022*** and the journal ***VLDBJ 2022*** .
...
* Three papers, related to sparse graph data, graph decomposition and our blackbox optimization (BBO) system -- [OpenBox], are accepted by the coference ***SIGKDD 2021***.
