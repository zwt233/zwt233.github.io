<img width="1473" height="800" alt="image" src="https://github.com/user-attachments/assets/50e7a31a-f6b2-4a01-b8f8-ad13cbd38703" />---
permalink: /
title: "About"
excerpt: "About me"
author_profile: true
...
张文涛，北京大学国际机器学习研究中心助理教授、研究员、博士生导师。北京大学未名青年学者，图灵班科研导师，智源学者。曾任职于腾讯机器学习平台部、Apple AIML和加拿大 Mila 人工智能实验室。研究兴趣为以数据为中心的人工智能（Data-centric AI, DCAI）、机器学习系统和AI4Science。 主持国家自然科学基金重大研究计划项目、科技部重点研发计划项目（课题）、教育部学科突破先导项目（Co-PI），近 5 年在机器学习（ICML/NeurIPS/ ICLR）、数据挖掘（SIGKDD/WWW）和数据管理（SIGMOD/VLDB/ICDE）等领域发表 CCF-A 类论文 100 （一作/通讯70+）余篇，2026年[CSRankings AI](https://csrankings.org/#/fromyear/2025/toyear/2026/index?ai&vision&mlmining&nlp&inforet&world)领域北京大学在职教师排名第一，也担任多个国际顶会的 PC Member/Area Chair。他获得多个最佳论文奖（如WWW’22-第一作者，APWeb’23-通讯作者，CIKM’24），领导或参与开源了多个机器学习系统，如大模型数据准备系统[DataFlow](https://github.com/OpenDCAI/DataFlow)、数据解析工具[MinerU](https://github.com/opendatalab/MinerU)和分布式机器学习系统Angel](https://github.com/Angel-ML/angel)。他曾获Apple Scholar、世界人工智能大会云帆奖、ACM SIGMOD 中国新星奖、世界互联网大会领先科技成果奖、华为火花奖、中国电子学会科技进步一等奖等多项荣誉。
...
- **3. 合作资源**
  ...
  - 工业界合作伙伴 (如Apple AIML、腾讯混元、华为、上海AI Lab、字节Seed、快手可灵、阿里Qwen、MSRA和蚂蚁等) Research实习和工作推荐，组里学生基本都有纯Research实习经历
  - 学术界合作伙伴（如Mila、Stanford、ETH、HKUST、NUS和UQ等）交流机会，推荐读博深造
  - 助研津贴（实习生视参与程度）
- **4. 其他**
...
**致有志于AI研究的学生:**
在当前高度竞争的AI人才生态中，无论是工业界顶尖计划（如TopSeed、阿里星、华为“天才少年”），还是学术界Top课题组博士招生与教职聘任，核心竞争力已从“论文数量”转向“综合影响力”。我将从以下五个维度全力支持你的成长：
- **1. 前沿务实的研究方向**
  - 聚焦真实需求与产业趋势，避免内卷赛道。例如，当前LLM Data方向需求旺盛，而我博士期间从事的GNN等领域已相对饱和。
- **2. 高质量顶会论文**
  - CCF-A顶会论文仍是重要门槛（多数头部项目要求3–5篇一作），但真正决定高度的是工作的影响力——是否被广泛引用、被主流开源项目采纳、解决关键问题。论文是科研成果的载体，不是目标。
- **3. 扎实的开源项目经历**
  - 主导或深度参与高星开源项目，是体现工程+研究能力、建立个人品牌的绝佳路径。研究生可围绕一个核心开源项目构建研究骨架，避免碎片化。
- **4. 工业界研究实习经历**
  - 当前很多突破性问题由工业界驱动——真实场景、海量数据、强大算力缺一不可。我本人博士期间在腾讯与Apple的长期实习经历，极大塑造了我的问题意识与研究视野。我鼓励并推荐学生进入头部企业或研究院实习，拓展视野、锤炼问题定义能力。
- **5. 课题组与研究平台**
  - 课题组的学术网络、合作资源、学校平台，将直接影响你的科研效率、合作机会与职业出口。
...
* **2025-02**: One paper is accepted by ***ICDE 2025***.
* **2025-01**: Two papers are accepted by ***IEEE TKDE 2025***.
